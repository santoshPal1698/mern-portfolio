export const content = {
  en: {
    ...
    callStrip1: "📞 Neeraj Pal:",
    callStrip2: "| 💬 Chat on WhatsApp",
    navLinks: ["Home", "Destinations", "Packages","Contact"],
    navIds: ["home", "destinations", "packages", "contact"],
    navCta: "📞 Book Now",
    ...
    packages: [
      {
        ...
        features:["Mahakaleshwar Darshan","Bhasma Aarti Priority","Kal Bhairav Temple","Shipra River Aarti","Guided Tour"],
      },
      {
        icon:"🕉️", title:"Divine Trio Package", price:"Starting ₹4,999/person", featured:true, badge:"MOST POPULAR",
        features:["Ujjain + Omkareshwar + Indore","3 Days 2 Nights","AC Transport",,"Both Jyotirlinga Darshan","All Meals Included","Expert Guide"],
      },
      {
        icon:"🛕", title:"Omkareshwar Special", price:"Starting ₹1,999/person",
        features:["Omkareshwar Jyotirlinga","Narmada Boat Ride","Mamleshwar Temple","Sunrise Aarti","Cab Included"],
      },
    ],
    galleryTag: "✦ Gallery ✦",
    ...
    contactItems: [
      ...
      {icon:"📞", label:"Mobile / WhatsApp", value:"+91 6265370030"},
      {icon:"👤", label:"Tour Coordinator", value:"Neeraj Pal"},
       {icon:"📞", label:"Mobile / WhatsApp", value:"+91 7879572717"},
    ...
    footerCopy: "© 2026 Dhruv Vihaan Tour & Travels • Dheeraj Pal • Indore, MP • All Rights Reserved",
