 ...
 * styles.js
 * ─────────────────────────────────────────────────────────────────────────────
 * ALL styled-components + keyframes for ViahaanTech Landing Page.
 * Import whatever you need in your component:
 *
 *   import { Nav, HeroWrap, BtnGrad, ... } from "./styles";
 *
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export const Burger = styled.div`
  ...
  span {
    ...
    background:${p => p.theme.indigo}; border-radius:2px; transition:all .3s;
  }
`;
...
export const HBadge = styled.div`
  ...
  color:${p => p.theme.indigo}; letter-spacing:2px;
  animation:${fadeUp} .7s ease both;
`;

export const Pip = styled.span`
  width:7px; height:7px; border-radius:50%;
  background:${p => p.theme.emerald};
...
export const HName = styled.h1`
  ...
  font-weight:900; line-height:.95; letter-spacing:-2px; margin-bottom:18px;
...
export const HBtns = styled.div`
  display:flex; gap:14px; justify-content:center; flex-wrap:wrap;
  animation:${fadeUp} .7s .45s ease both;
`;

export const BtnGrad = styled.a`
...
export const StatL = styled.div`
  font-size:.75rem; color:${p => p.theme.muted}; letter-spacing:1px; margin-top:3px;
`;
...
export const WaveTrack = styled.div`
...
export const AvatarCore = styled.div`
...
export const IEmoji = styled.span`font-size:18px; margin-top:1px; flex-shrink:0`;

export const IText = styled.div`
  small {
    font-family:'Fira Code',monospace; font-size:.65rem;
    color:${p => p.theme.muted}; letter-spacing:1px; display:block;
  }
  strong {
    font-size:.88rem; color:${p => p.theme.white}; font-weight:600;
    line-height:1.3; display:block; margin-top:2px;
  }
`;

export const SkillBlock = styled.div`width:100%; max-width:340px`;

export const SBar = styled.div`margin-bottom:12px`;

export const SBarLabel = styled.div`
  display:flex; justify-content:space-between; font-size:.78rem; margin-bottom:6px;
...
export const PillIcon       = styled.span`font-size:18px; line-height:1`;
...
export const SvcCard  = styled.div`
  ...
  &:hover { transform:translateY(-7px); border-color:rgba(99,102,241,.4); &::before { transform:scaleX(1) } }
`;

export const SvcIco   = styled.div`
...
export const SvcTitle = styled.h3`
  font-family:'Exo 2',sans-serif; font-size:.97rem; font-weight:800;
  margin-bottom:10px; color:${p => p.theme.white};
`;

export const SvcDesc  = styled.p`font-size:.87rem; color:${p => p.theme.muted}; line-height:1.7`;

export const SvcTags  = styled.div`display:flex; flex-wrap:wrap; gap:7px; margin-top:16px`;

export const STg      = styled.span`
...
export const PriceLbl = styled.div`
...
export const ProcWrap = styled.div`
...
export const PNum     = styled.div`
  font-family:'Exo 2',sans-serif; font-size:2.6rem; font-weight:900;
  background:${p => p.theme.grad1}; -webkit-background-clip:text; -webkit-text-fill-color:transparent;
  line-height:1; margin-bottom:12px;
`;

export const PEmoji   = styled.div`font-size:28px; margin-bottom:10px`;
...
export const PDesc    = styled.p`font-size:.83rem; color:${p => p.theme.muted}; line-height:1.65`;

/* ═══════════════════════════════════════════════════════════════════════════
   11. PORTFOLIO
═══════════════════════════════════════════════════════════════════════════ */

export const PortGrid  = styled.div`
...
export const PortThumb = styled.div`
...
export const PortBody  = styled.div`padding:22px 22px 0`;

export const PortTitle = styled.h3`
  font-family:'Exo 2',sans-serif; font-size:.95rem; font-weight:800; margin-bottom:7px;
`;

export const PortDesc  = styled.p`font-size:.84rem; color:${p => p.theme.muted}; line-height:1.65`;
...
export const PlatLogo     = styled.div`
...
export const PlatName     = styled.h3`
  font-family:'Exo 2',sans-serif; font-size:1.4rem; font-weight:900;
  margin-bottom:6px; color:${p => p.theme.white};
`;

export const PlatSub      = styled.p`
  font-size:.85rem; color:${p => p.theme.muted}; line-height:1.7; margin-bottom:20px;
`;

export const PlatStats    = styled.div`display:flex; gap:20px; flex-wrap:wrap; margin-bottom:22px`;

export const PStat        = styled.div`
  strong {
    display:block; font-family:'Exo 2',sans-serif; font-weight:800; font-size:1.3rem;
    color:${p => p.$c};
  }
  small {
    font-family:'Fira Code',monospace; font-size:.65rem;
    color:${p => p.theme.muted}; letter-spacing:1px;
  }
`;

export const PlatLink     = styled.a`
  display:inline-flex; align-items:center; gap:8px;
...
export const PlatBadges   = styled.div`display:flex; gap:8px; flex-wrap:wrap; margin-top:14px`;
...
export const WhyIco  = styled.div`
...
export const CInfoCard = styled.div`
...
export const CText     = styled.div`
  small {
    font-family:'Fira Code',monospace; font-size:.65rem;
    color:${p => p.theme.muted}; letter-spacing:1.5px;
...
export const FGroup    = styled.div`margin-bottom:14px`;
...
export const FootLinks = styled.div`
  ...
  a {
    ...
    color:${p => p.theme.muted}; letter-spacing:1px; cursor:pointer;
    &:hover { color:${p => p.theme.cyan} }
  }
`;